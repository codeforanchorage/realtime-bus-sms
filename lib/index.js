 ...
 function getStopsFromAddress(address){
    ...
    .then((returnObj) => {
        ...
        if (!geocodedAddress || !geocodedAddress.streetName) { // This lies to the user if there is a geocoder error like a bad apiKey. 
            return Promise.reject({name: "I couldn't find that address", message:`I searched for "${addressWithCity}." You could try sending the nearest major intection instead.`})
        }
