...
/** 
Returns an object which is: {data: result, asyncTime: timing of request  }
asyncTime is how long the bustracker site took
**/
function getStopFromStopNumber(stopId) {
    ...
    .then((returnObj)=>{ 
        return {data: parseBusData(returnObj.data, stopId), asyncTime:returnObj.asyncTime};
    })
...
**/
 ...
 function getStopsFromAddress(address){
    ...
    .then((returnObj) => {
        ...
        return {data: {stops: stops, geocodedAddress:geocodedAddress} , asyncTime: returnObj.asyncTime};
    })
}
