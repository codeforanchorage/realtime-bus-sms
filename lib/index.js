...
function parseInputReturnBusTimes(message, callback, returnHtml) {
    ...
    if (message.trim().toLowerCase() === 'about') {
        return resultsHandler(null, 'To get bus ETAs, text the bus stop #. If you do not know the bus stop #, text the closest street address or closest cross streets to the bus stop and it will return up to the 5 closest stops within a mile radius. Text Feedback at beginning of text to send feedback. Code for Anchorage project.');
    }
