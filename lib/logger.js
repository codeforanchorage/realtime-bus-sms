...
/* ROLLBAR ERROR LOGGING 
   ...
   To send a Rollbar error message use:
   logger.error(error) 
   Rollbar will be expecting an error object and will report the message and stack trace
   TODO: maybe allow finer-grained messages with additional context
*/
